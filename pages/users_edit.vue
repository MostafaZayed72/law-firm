<template>
  ...
  const fetchEmployees = async () => {
    ...
    try {
      const response = await axios.get('https://backend.lawyerstor.com/api/users?populate=*', {
        headers: {
  ...
  const deleteEmployee = async (id) => {
    ...
    try {
      await axios.delete(`https://backend.lawyerstor.com/api/users/${id}`, {
        headers: {
          Authorization: `Bearer ${jwt}`,
        }
      });
  ...
  const saveEdits = async () => {
    ...
    try {
      ...
      const response = await axios.put(`https://backend.lawyerstor.com/api/users/${userId}`, {
